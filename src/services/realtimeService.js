...
import { getBasePrompt, getTelephonyPrompt } from "../utils/prompt.js";
...
export async function connectToRealtimeAPI(
  ...
  console.log("Channel Going to RealTimeService: ", channel);
  ...
  ------------------------- */
  const baseInstructions = getBasePrompt(now, timezone);

  const telephonyInstructions =
    channel === "telephony" ? getTelephonyPrompt() : "";
